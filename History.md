# Ansible Role zsh History
This role was forked in 2022 from the original [viasite-ansible/ansible-role-zsh](https://github.com/viasite-ansible/ansible-role-zsh).

The fork's purpose was to fix issues that made the use of the role impossible for me. But since my Pull Requests will probably never be merged I decided to maintain the project myself.

# viasite-ansible/ansible-role-zsh

This is a copy of the READDME of the [original project](https://github.com/viasite-ansible/ansible-role-zsh).
